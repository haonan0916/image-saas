...
export default function TestDehazePage() {
    ...
    return (
        <div className="container mx-auto p-8 space-y-8">
            <h1 className="text-3xl font-bold">{dict.test.dehazeTitle}</h1>

            {/* 图像对比组件测试 */}
            <div className="space-y-4">
                <h2 className="text-2xl font-semibold">{dict.test.imageCompare} ({dict.test.debugVersion})</h2>

                {imageError && (
                    <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded">
                        dict.common.error: {imageError}
                    </div>
                )}
            ...
            <div className="space-y-4">
                ...
                <div className="bg-muted p-6 rounded-lg space-y-4">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                        <li>{`如果一直显示dict.common.loading，请检查图片路径是否正确`}</li>
